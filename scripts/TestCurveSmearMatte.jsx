...
(function () {
    ...
    try {
        ...
        black.enabled = false;
        white.enabled = false;
        fx.property('Source Matte').setValue(black.index);
        fx.property('Matte Channel').setValue(1);
        renderStill(comp, 'matte-black-luma');
        fx.property('Source Matte').setValue(white.index);
        renderStill(comp, 'matte-white-luma');
        fx.property('Source Matte').setValue(black.index);
        fx.property('Matte Channel').setValue(2);
