...
run([compiler,'/nologo','/std:c++17','/EHsc','/O2','/MT','/LD','/W4','/D_CRT_SECURE_NO_WARNINGS','/DMSWindows','/D_WINDOWS',*includes,ROOT/'native/CurveSmear.cpp',build/'CurveSmear.res','/link',f'/OUT:{dist / "CurveSmear.aex"}'])
print('Built:',dist/'CurveSmear.aex')
if args.tests:
